...
str2=['~/Desktop/stims/stim_testje','.atf'];
fid = fopen(char(str2),'w');
% 
fprintf(fid,'%s\t%s\n %s\t%s\n %s\n %s\n %s\n %s\n %s\n %s\n %s\n %s\n %s\t%s\n %s\t%s\n', 'ATF',	'1.0','8', '3     ', '"AcquisitionMode=Episodic Stimulation"', 'sweeps= 5', '"Comment= Created by tycho.hoogland@gmail.com"', '"YTop=5"',  '"YBottom=0"', '"SyncTimeUnits=10"', '"SweepStartTimesMS=0.000"', '"SignalsExported=OUT0"', '"Signals= "',	'"V"', '"Time (s)"','"OUT0 (V)"');
